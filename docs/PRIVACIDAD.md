...
Los perfiles propios de condiciones (nombre, centros, alias, horarios, calendarios locales y condiciones fiscales opcionales) forman parte de tus datos locales y copias JSON. No se publican en GitHub. El perfil predefinido MFyC · FJD contiene condiciones de trabajo, calendario elegido y supuestos fiscales básicos. No incluye fechas personales, recibos, calendario privado ni importes fiscales del usuario.
